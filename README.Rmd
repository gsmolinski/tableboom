...
```{r image_tableboom, echo = FALSE}
tableboom_example_path <- file.path(system.file(package = "tableboom", "help"),
                                    "figures", "README-tableboom.png")
knitr::include_graphics(tableboom_example_path)
```
